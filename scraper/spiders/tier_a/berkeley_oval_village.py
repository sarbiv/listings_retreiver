"""
Spider for Berkeley Group - Oval Village (London)
"""
import scrapy
import structlog
...
class BerkeleyOvalVillageSpider(BaseTierASpider):
    """Spider for Berkeley Group - Oval Village"""
    
    name = 'berkeley_oval_village'
    allowed_domains = ['berkeleygroup.co.uk']
    start_urls = ['https://www.berkeleygroup.co.uk/developments/london/oval/oval-village']
    
    def extract_spider_specific_project_data(self, response: Response) -> Dict[str, Any]:
        """Extract Berkeley Oval Village specific project data"""
        ...
        if developer:
            ...
            project_data['developer_name'] = 'Berkeley Group'
        ...
        project_data['city'] = 'London'
        project_data['country'] = 'United Kingdom'
    ...
    def extract_spider_specific_amenities(self, response: Response) -> List[str]:
        """Extract Berkeley Oval Village specific amenities"""
        selector = response.selector
        amenities = []
    ...
    def extract_spider_specific_media_links(self, response: Response) -> List[Dict[str, str]]:
        """Extract Berkeley Oval Village specific media links"""
        selector = response.selector
        media_links = []
